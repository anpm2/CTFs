<html>
  <head>
    ...
    <title>encrypted By Wanna Scream</title>
  ...
  <body>
    <div class='header'>
		...
		<div>All your files have been encrypted by Wanna Scream!</div>
	</div>
    <div class='bold'>due to a security problem with your PC. If you want to restore them, write us to the e-mail <span class='mark'>decryptprof@mailfence.com</span></div>
      <div class="bold">Write this ID in the title of your message:<span class='mark'>B04883D6</span></span></div>
	<div class='bold'>In case of no answer in 24 hours write us to this e-mail:<span class='mark'>decryptprof@mailfence.com</span></div>
    <div>
